...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "Name", "Ingredients", "Category", "Image", "Favorite / Not"
            }
        ) {
    ...
    private void menuAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuAddActionPerformed
        ...
        try {
            ...
            e.printStackTrace();
                    ...
                    JOptionPane.showMessageDialog(null, "Are you sure you will add a recipe?");
    ...
    private void menuDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuDeleteActionPerformed
        ...
        try {
            ...
            for (int i = 0; i < rows.length; i++) {
                ...
                resultSet.deleteRow();
                model.removeRow(row);
                JOptionPane.showMessageDialog(null, "This recipe has been deleted");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void selectImage() {
        ...
        ch.setFileFilter(new FileFilter() {
            ...
            public boolean accept(File file) {
                ...
                return file.isDirectory() || name.endsWith(".jpg") || name.endsWith(".png")|| name.endsWith(".jfif")|| name.endsWith(".webp");
            }
